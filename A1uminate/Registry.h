...
auto CoreGetComponentRegistry()
{
	static struct RefSource
	{
		...
		{
#ifdef _WIN32
			auto func = (ComponentRegistry*(*)())GetProcAddress(GetModuleA("CoreRT.dll"), "CoreGetComponentRegistry");
#else
	...
	auto CoreGetGlobalInstanceRegistry()
{
    static struct RefSource
    {
        ...
        {
#ifdef _WIN32
            auto func = (InstanceRegistry*(*)())GetProcAddress(GetModuleA("CoreRT.dll"), "CoreGetGlobalInstanceRegistry");
#else
